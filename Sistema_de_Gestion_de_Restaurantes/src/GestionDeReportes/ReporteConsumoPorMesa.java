...
public class ReporteConsumoPorMesa implements Serializable {
    ...
    // Constructor que inicializa la fecha actual de creación del reporte
    ...
    // Acumula y calcula el importe total consumido por cada mesa en las facturas provistas
    ...
    // Calcula el importe promedio gastado por mesa en función de su cantidad de usos
    ...
    // Genera una cadena estructurada con el desglose de consumo por mesa y la fecha
    public String generarReporte(ArrayList<Factura> facturas) {
        ...
        for (Map.Entry<Mesa, Double> entry : consumo.entrySet()) {
            ...
            sb.append(m).append(", Consumo total de la mesa: ").append(String.format("%.2f", total)).append("\n");
        }
